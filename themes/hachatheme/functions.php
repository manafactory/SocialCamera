		...
		<div class="container">
			<div class="row">
				<div class="col-lg-12">
					...
					<div class="nav-previous"><?php next_posts_link( __( '<span class="meta-nav">&larr;</span> Tweet precedenti', 'ward' ) ); ?></div>
					<?php endif; ?>

					<?php if ( get_previous_posts_link() ) : ?>
					<div class="nav-next"><?php previous_posts_link( __( 'Tweet successivi <span class="meta-nav">&rarr;</span>', 'ward' ) ); ?></div>
					<?php endif; ?>
				</div>
			</div>
		</div>
		...
		<div class="container">
			<div class="row">
				<div class="home-jumbotron jumbotron col-lg-10 col-lg-offset-1 col-sm-12">
					...
					<p class="lead"><i><?php echo $bavotasan_theme_options['jumbo_headline_text']; ?></i></p>
					<?php if ( ! empty( $bavotasan_theme_options['jumbo_headline_button_text'] ) ) { ?>
					<a class="btn btn-lg btn-primary" href="<?php echo $bavotasan_theme_options['jumbo_headline_button_link']; ?>"><i><?php echo $bavotasan_theme_options['jumbo_headline_button_text']; ?></i></a>
					<?php } ?>


<?php
 if(is_tax("search_keyword")){
   
   $chiave = "classifica_".get_query_var( 'term' );
   //echo $chiave;
   $numclassifica = get_option($chiave);
   
   
   echo "<i class='middle-circle'  style='width:120px; height:120px;background-color:#ffe400; text-align:center; '><h2><b>".$numclassifica."</b>&deg;</h2><h5>Classifica</h5><h5>Twitter</h5></i>";
